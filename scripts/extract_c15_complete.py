#!/usr/bin/env python3
"""
Complete, High-Precision Cambridge 15 Extractor for CD-IELTS Simulator.
Extracts all 4 tests (Listening, Reading, Writing) directly from digital text in
'Cambridge IELTS 15/Cambridge IELTS 15.pdf' using Gemini flash-lite and official answer keys.
"""
...
PDF_PATH = "Cambridge IELTS 15/Cambridge IELTS 15.pdf"
...
C15_CONFIG = {
    1: {
        "Listening": {
            "pages": list(range(12, 18)),
            "ans_page": 121,
            "audio_files": [
                "ielts15_test1_audio1.m4a",
                "ielts15_test1_audio2.m4a",
                "ielts15_test1_audio3.m4a",
                "ielts15_test1_audio4.m4a"
            ]
        },
        "Reading": {
    ...
    2: {
        "Listening": {
            ...
            "audio_files": [
                ...
                "ielts15_test2_audio2.m4a",
                "ielts15_test2_audio3.m4a",
                "ielts15_test2_audio4.m4a"
            ]
        },
        "Reading": {
    ...
    3: {
        "Listening": {
            ...
            "ans_page": 125,
            "audio_files": [
                "ielts15_test3_audio1.m4a",
                "ielts15_test3_audio2.m4a",
                "ielts15_test3_audio3.m4a",
                "ielts15_test3_audio4.m4a"
            ]
        },
        "Reading": {
            "pages": list(range(60, 73)),
            "ans_page": 126,
            "audio_files": []
        },
        "Writing": {
    ...
    4: {
        "Listening": {
            "pages": list(range(76, 82)),
            "ans_page": 127,
            "audio_files": [
                "ielts15_test4_audio1.m4a",
                "ielts15_test4_audio2.m4a",
                "ielts15_test4_audio3.m4a",
                "ielts15_test4_audio4.m4a"
            ]
        },
        "Reading": {
            "pages": list(range(82, 95)),
            "ans_page": 128,
            "audio_files": []
        },
        "Writing": {
...
def extract_module(client, doc, test_num, module_name, cfg):
    out_file = os.path.join(OUTPUT_DIR, f"c15_test{test_num}_{module_name.lower()}.json")
    print(f"\n=======================================================")
    print(f"Extracting Cambridge 15 Test {test_num} {module_name}...")
    print(f"=======================================================")
...
Format Cambridge 15 Test {test_num} {module_name} into CD-IELTS JSON schema.
Module: {module_name}
...
{{
  ...
  "test": {test_num},
  "module": "{module_name}",
  "title": "Cambridge 15 {module_name} Test {test_num}",
  "parts": [
    {{
      "part_number": 1,
    ...
    for m in models:
        for attempt in range(3):
            try:
                ...
                data["title"] = f"Cambridge 15 {module_name} Test {test_num}"
...
def main():
    print("Starting Cambridge 15 Complete Extraction Suite...")
    ...
    print(f"\n=======================================================")
    print(f"FINISHED! Successfully extracted {success_count}/{total_count} modules for Cambridge 15.")
    print(f"=======================================================")
