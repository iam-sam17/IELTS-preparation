#!/usr/bin/env python3
"""
Complete, High-Precision Cambridge 17 Extractor for CD-IELTS Simulator.
Extracts all 4 tests (Listening, Reading, Writing) directly from digital text in
'Cambridge IELTS 17/Cambridge IELTS 17.pdf' using Gemini flash-lite and official answer keys.
"""
...
PDF_PATH = "Cambridge IELTS 17/Cambridge IELTS 17.pdf"
...
C17_CONFIG = {
    1: {
        "Listening": {
            ...
            "ans_page": 113,
            "audio_files": [
                "IELTS17_t1_audio1 [@cambridge_library].mp3",
                "IELTS17_t1_audio2 [@cambridge_library].mp3",
                "IELTS17_t1_audio3 [@cambridge_library].mp3",
                "IELTS17_t1_audio4 [@cambridge_library].mp3"
            ]
        },
        "Reading": {
            "pages": list(range(10, 22)),
            "ans_page": 114,
            "audio_files": []
        },
        "Writing": {
    ...
    2: {
        "Listening": {
            "pages": list(range(25, 31)),
            "ans_page": 115,
            "audio_files": [
                "IELTS17_t2_audio1 [@cambridge_library].mp3",
                "IELTS17_t2_audio2 [@cambridge_library].mp3",
                "IELTS17_t2_audio3 [@cambridge_library].mp3",
                "IELTS17_t2_audio4 [@cambridge_library].mp3"
            ]
        },
        "Reading": {
            "pages": list(range(31, 44)),
            "ans_page": 116,
            "audio_files": []
        },
        "Writing": {
    ...
    3: {
        "Listening": {
            "pages": list(range(47, 54)),
            "ans_page": 117,
            "audio_files": [
                "IELTS17_t3_audio1 [@cambridge_library].mp3",
                "IELTS17_t3_audio2 [@cambridge_library].mp3",
                "IELTS17_t3_audio3 [@cambridge_library].mp3",
                "IELTS17_t3_audio4 [@cambridge_library].mp3"
            ]
        },
        "Reading": {
            "pages": list(range(54, 66)),
            "ans_page": 118,
            "audio_files": []
        },
        "Writing": {
    ...
    4: {
        "Listening": {
            "pages": list(range(69, 75)),
            "ans_page": 119,
            "audio_files": [
                "IELTS17_t4_audio1 [@cambridge_library].mp3",
                "IELTS17_t4_audio2 [@cambridge_library].mp3",
                "IELTS17_t4_audio3 [@cambridge_library].mp3",
                "IELTS17_t4_audio4 [@cambridge_library].mp3"
            ]
        },
        "Reading": {
            "pages": list(range(75, 87)),
            "ans_page": 120,
            "audio_files": []
        },
        "Writing": {
...
def extract_module(client, doc, test_num, module_name, cfg):
    out_file = os.path.join(OUTPUT_DIR, f"c17_test{test_num}_{module_name.lower()}.json")
    print(f"\n=======================================================")
    print(f"Extracting Cambridge 17 Test {test_num} {module_name}...")
    print(f"=======================================================")
...
Format Cambridge 17 Test {test_num} {module_name} into CD-IELTS JSON schema.
Module: {module_name}
...
{{
  ...
  "test": {test_num},
  "module": "{module_name}",
  "title": "Cambridge 17 {module_name} Test {test_num}",
  "parts": [
    {{
      "part_number": 1,
    ...
    for m in models:
        for attempt in range(3):
            try:
                ...
                data["title"] = f"Cambridge 17 {module_name} Test {test_num}"
...
def main():
    print("Starting Cambridge 17 Complete Extraction Suite...")
    ...
    print(f"\n=======================================================")
    print(f"FINISHED! Successfully extracted {success_count}/{total_count} modules for Cambridge 17.")
    print(f"=======================================================")
