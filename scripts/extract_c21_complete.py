#!/usr/bin/env python3
"""
Complete, High-Precision Cambridge 21 Extractor for CD-IELTS Simulator.
Extracts all 4 tests (Listening, Reading, Writing) directly from digital text in
'Cambridge IELTS 21/@IELTS_Practice_Tests.pdf' using Gemini and official answer keys.
"""
...
PDF_PATH = "Cambridge IELTS 21/@IELTS_Practice_Tests.pdf"
...
C21_CONFIG = {
    1: {
        "Listening": {
            ...
            "ans_page": 118,
            "audio_files": ["C21T1P1.1.mp3", "C21T1P2.1.mp3", "C21T1P3.1.mp3", "C21T1P4.mp3"]
        },
        "Reading": {
    ...
    2: {
        "Listening": {
            ...
            "ans_page": 120,
            "audio_files": ["C21T2P1.mp3", "C21T2P2.1.mp3", "C21T2P3.1.mp3", "C21T2P4.mp3"]
        },
        "Reading": {
            "pages": list(range(39, 52)),
            "ans_page": 121,
            "audio_files": []
        },
        "Writing": {
    ...
    3: {
        "Listening": {
            ...
            "ans_page": 122,
            "audio_files": ["C21T3P1.mp3", "C21T3P2.1.mp3", "C21T3P3.1.mp3", "C21T3P4.mp3"]
        },
        "Reading": {
    ...
    4: {
        "Listening": {
            ...
            "ans_page": 124,
            "audio_files": ["C21T4P1.mp3", "C21T4P2.1.mp3", "C21T4P3.1.mp3", "C21T4P4.mp3"]
        },
        "Reading": {
...
def extract_module(client, doc, test_num, module_name, cfg):
    out_file = os.path.join(OUTPUT_DIR, f"c21_test{test_num}_{module_name.lower()}.json")
    print(f"\n=======================================================")
    print(f"Extracting Cambridge 21 Test {test_num} {module_name}...")
    print(f"=======================================================")
...
Format Cambridge 21 Test {test_num} {module_name} into CD-IELTS JSON schema.
Module: {module_name}
...
{{
  ...
  "test": {test_num},
  "module": "{module_name}",
  "title": "Cambridge 21 {module_name} Test {test_num}",
  "parts": [
    {{
      "part_number": 1,
    ...
    for m in models:
        for attempt in range(3):
            try:
                ...
                data["title"] = f"Cambridge 21 {module_name} Test {test_num}"
...
def main():
    print("Starting Cambridge 21 Complete Extraction Suite...")
    ...
    print(f"\n=======================================================")
    print(f"FINISHED! Successfully extracted {success_count}/{total_count} modules for Cambridge 21.")
    print(f"=======================================================")
